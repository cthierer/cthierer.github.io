        ...
        <StaticQuery
          ...
          render={({
            profileYaml: {
              name,
              title: jobTitle,
              contact: { email_main: email, website_main: website } = {},
              address: {
                street, city, state, zip,
              } = {},
            } = {},
            profile: {
              frontmatter: { title: profileTitle },
              html: profileBody,
            },
            skills: {
              frontmatter: { title: skillsTitle, featuredSkills = [] } = {},
              html: skillsBody,
            } = {},
            experienceOverview: {
              frontmatter: { title: experienceTitle } = {},
            } = {},
            experience: { edges: experiences = [] } = {},
            educationOverview: {
              frontmatter: { title: educationTitle } = {},
            } = {},
            education: { edges: degrees = [] } = {},
          }) => (
                    ...
                    {experiences.map(
                      ({
                        ...
                        <Grid.Row key={title} className={classes.experience}>
                          <Grid.Column width={4}>
                            <h3 className={classes.entryHeader}>{role}</h3>
                            <p className={classes.narrow}>{company}</p>
